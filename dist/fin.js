...
function advancePositionWithClone(pos, source, numberOfCharacters = source.length) {
  return advancePositionWithMutation(
    (0,shared_esm_bundler.extend)({}, pos),
    source,
    numberOfCharacters
  );
}
...
const isSpecialTemplateDirective = /* @__PURE__ */ (0,shared_esm_bundler.makeMap)(
...
function baseCompile(template, options = {}) {
  ...
  transform(
    ast,
    (0,shared_esm_bundler.extend)({}, options, {
      prefixIdentifiers,
      nodeTransforms: [
        ...nodeTransforms,
...
const isRawTextContainer = /* @__PURE__ */ (0,shared_esm_bundler.makeMap)(
...
/* harmony export */   Tn: () => (/* binding */ toValue),
...
/* harmony export */   EM: () => (/* binding */ hasInjectionContext),
...
/* harmony export */   Gn: () => (/* binding */ defineModel),
...
/* harmony export */   Tn: () => (/* reexport safe */ _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.Tn),
...
/* harmony export */   Vf: () => (/* binding */ mergeModels),
...
/* harmony export */   Wl: () => (/* binding */ defineSlots),
...
/* harmony export */   Yu: () => (/* binding */ defineOptions),
...
/* harmony export */   tT: () => (/* binding */ useModel),
...
function useModel(props, name, options) {
  ...
  if (options && options.local) {
    const proxy = (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__/* .ref */ .iH)(props[name]);
    watch(
      () => props[name],
      (v) => proxy.value = v
    );
...
const normalizeRef = ({
  ...
  return ref != null ? (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(ref) || (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__/* .isRef */ .dq)(ref) || (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(ref) ? { i: currentRenderingInstance, r: ref, k: ref_key, f: !!ref_for } : ref : null;
};
...
function guardReactiveProps(props) {
  if (!props)
    return null;
  return (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__/* .isProxy */ .X3)(props) || InternalObjectKey in props ? (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)({}, props) : props;
}
...
/* harmony export */   BaseTransitionPropsValidators: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.nJ),
...
/* harmony export */   defineModel: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.Gn),
/* harmony export */   defineOptions: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.Yu),
/* harmony export */   defineProps: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.MW),
/* harmony export */   defineSSRCustomElement: () => (/* binding */ defineSSRCustomElement),
/* harmony export */   defineSlots: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.Wl),
...
/* harmony export */   hasInjectionContext: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.EM),
...
/* harmony export */   mergeModels: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.Vf),
...
/* harmony export */   toValue: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.Tn),
...
/* harmony export */   useModel: () => (/* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.tT),
...
function createInvoker(initialValue, instance) {
  const invoker = (e) => {
    ...
    (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__/* .callWithAsyncErrorHandling */ .$d)(
...
const TransitionPropsValidators = Transition.props = /* @__PURE__ */ (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)(
  {},
  _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__/* .BaseTransitionPropsValidators */ .nJ,
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      for (let i = 0; i < children.length; i++) {
        const child = children[i];
        if (child.key != null) {
          (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__/* .setTransitionHooks */ .nK)(
            child,
            (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__/* .resolveTransitionHooks */ .U2)(child, cssTransitionProps, state, instance)
          );
        } else if (false) {}
      }
      if (prevChildren) {
...
function ensureHydrationRenderer() {
  renderer = enabledHydration ? renderer : (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__/* .createHydrationRenderer */ .Eo)(rendererOptions);
...
function questionsPageInit() {
  ...
  const _questionss = [{
    ...
    selectors: [$("#total_investment_and_savings"), $("#monthly_investment_and_savings")],
      ...
      selector.keyup(function () {
        ...
        if ($(this).val() !== "") {
          if (parseInt($(this).val()) > 0) {
            $(this).val(toCurrencyWithoutDollar($(this).val().replace(/[^\d]/g, "")));
          } else {
            $(this).val("");
          }
        } else {
  ...
  async function createNewProspect() {
    ...
    const data = {
      ...
      montlyInvestMentAndSavings: parseInt($("#monthly_investment_and_savings").val().replace(/,/g, "")) || 0,
      totalInvestmentAndSavings: parseInt($("#total_investment_and_savings").val().replace(/,/g, "")),
      retirement_age,
      pension_choice,
      guessed_fin,
      email: emailEl.val(),
...
const getVideoMessage = function (user_id, tool = null) {
  ...
  if ((0,videomessage_utils.isFinPath)()) {
    const tools = !(0,utils.isEmpty)(tool) ? [tool] : ['fin_path', 'fin_path_start', 'fin_path_end'];
  ...
  } else if ((0,videomessage_utils.isIPN)()) {
    queryParams.push({
      key: 'tool',
      value: 'ipn'
    });
...
function init(advisorName = '', tool = null) {
  (0,runtime_dom_esm_bundler.createApp)({
    ...
    render() {
      return (0,runtime_core_esm_bundler.h)('div', {
      ...
      }, !(0,videomessage_utils.isFinPath)() && !(0,videomessage_utils.isIPN)() ? this.description.replace(/repname/g, advisorName || utils.cookies.get('FIRST_NAME') || utils.cookies.get('REP_NAME')) : null), (0,runtime_core_esm_bundler.h)('div', {
        class: {
          'video-overlay': true,
          'mx-center mt-12': !(0,videomessage_utils.isFinPath)() && !(0,videomessage_utils.isIPN)()
        },
        onMouseover: () => {
        ...
        class: {
          'd-flex video-overlay position-absolute justify-content-center align-items-center space-x-2': true
        }
      ...
      }), this.showOverLay && this.showPlayButton === 'playing' ? (0,runtime_core_esm_bundler.h)('div', {
        class: {
      ...
      })]) : null]), (0,runtime_core_esm_bundler.h)(videoComponent)])]);
    },
    methods: {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getBrandPersonalization: () => (/* binding */ getBrandPersonalization),
...
const getBrandPersonalization = async USER_ID => {
  ...
  return await new Promise((resolve, reject) => {
    brandPersonalization.find().then(response => {
...
/* harmony export */   isFinalPage: () => (/* binding */ isFinalPage),
...
/* harmony export */   toCurrencyWithoutDollar: () => (/* binding */ toCurrencyWithoutDollar),
  ...
  videos: {
    ...
    handleLang({
      ...
      $(selector).click(function () {
        ...
        cookies.set('isCanadian', country ? country.toLowerCase() === 'ca' : IS_CANADIAN_LINK);
        that.renderVideo(getVideoUrl(language, country ? country === 'ca' : IS_CANADIAN_LINK));
        Weglot.switchTo(language);
        cookies.set('country', getCountry(country ? country === 'ca' : IS_CANADIAN_LINK), true);
      });
    },
    ...
    handleLanguages: function (IS_CANADIAN_LINK) {
      ...
      const IS_EXPERIOR = isExperiorCookie ? JSON.parse(isExperiorCookie) : false;
      if (IS_EXPERIOR) {
...
.video-container {
  border: 6px solid rgba(110, 89, 174, 0.5);
}
.bg-white {
...
function InitRouteQuestions() {
  ...
  const redirectTo = `${window.location.origin}/schedule`;
  if (!(0,utils.isMobile)()) {
      ...
      progressBar() {
        return h("div", {
          ...
          style: {
            ...
            top: (0,utils.isMobile)() ? "71px" : "100px",
            position: "fixed"
          }
        }, [h("div", {
...
function initFinalStep() {
  ...
  function handlePublicFeatures() {
    ...
    if (publicFeatures) {
      ...
      if (!finPath) {
        ...
        hasIpn = true;
        if (hasIpn) {
          $(".image-48").attr("src", "https://discoverfin.s3.amazonaws.com/assets/IPN.svg");
        }
        $(".open-video").remove();
  ...
  const ipn_base = window.location.hostname.includes("dev") ? "ipn.fintell.io" : "incomeprotection.ai";
  const openIpn = () => {
  ...
  async function populatePathOptions() {
    ...
    if (!(video_message_available && JSON.parse(video_message_available))) {
      $("#main_copy").html(`Click on either of the buttons below to schedule an appointment with me to learn more about your financial intelligence number.`);
    }
...
var videomessages = __webpack_require__(1279);
