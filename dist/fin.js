  ...
  createApp({
    ...
    methods: {
      ...
      questionsContainer() {
        ...
        }, getCurrentLanguage() === "en" ? this.currentQuestion.question : this.currentQuestion.es), h("span", {
          style: !(0,utils.isMobile)() ? {
            fontSize: "16px"
          } : {}
...
function initFinalStep() {
  ...
  $("#user-name").text(utils.cookies.get("Name"));
  $("#rep_name").text(rep_name);
  ...
  async function populatePathOptions() {
    ...
    $("#fin_number").text(Intl.NumberFormat("en-US", {
      style: "currency",
      currency: "USD",
      maximumFractionDigits: 0
