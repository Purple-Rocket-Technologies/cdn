...
function initFinalStep() {
  ...
  $("#rep_name").text(rep_name);
  $("#rep-image").attr("src", utils.cookies.get("PIC"));
  $(".rep-phoito").css("background-image", "url('" + utils.cookies.get("PIC") + "')");
  ...
  const openFINPath = email => {
    window.open(`https://finpath.discoverfin.io/demopurple/start?email=${email}`, "_blank");
  };
