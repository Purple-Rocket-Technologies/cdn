...
// EXTERNAL MODULE: ./src/schema/constants.js
var constants = __webpack_require__(602);
// EXTERNAL MODULE: ./src/service/fin/routeQuestion.service.js
var routeQuestion_service = __webpack_require__(676);
...
function InitRouteQuestions() {
  const type = (0,constants.getLastSlash)(window.location.pathname).replace(/-/g, "_").toUpperCase();
  ...
  createApp({
    data() {
      return {
        progress: 0,
        currentIndex: 0,
        questions: constants.questions[type]
      };
    },
    ...
    methods: {
      buttonChild(className) {
        return [h("img", {
          ...
          src: constants.buttonArrowImage
        }), h("div", {
          class: {
            button_active: true,
      ...
      questionItem(question) {
        return h("div", {
          ...
          style: {
            backgroundColor: this.selectedAnswers && this.has(this.currentQuestion.answer, question.value) ? constants.colors.green : constants.colors.white,
            color: this.selectedAnswers && this.has(this.currentQuestion.answer, question.value) ? constants.colors.white : constants.colors.blue,
      ...
      submitAnswers() {
        (0,routeQuestion_service.saveAnswers)((0,utils.formatAnswers)(this.questions), utils.cookies.get("COMPANY_ID"), utils.cookies.get("PROSPECT_ID")).then(res => {
...
var Service = __webpack_require__(912);
...
console.log((0,utils.isRouteQuestionPage)(true), "true");
console.log((0,utils.isRouteQuestionPage)(false), "dalse");
})();
