(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("finWidget", [], factory);
	else if(typeof exports === 'object')
		exports["finWidget"] = factory();
	else
		root["finWidget"] = factory();
})(self, () => {
...
___CSS_LOADER_EXPORT___.push([module.id, `@font-face {
  font-family: Trenda;
  src: url('https://uploads-ssl.webflow.com/5f2b119ee036c0684f3c3c36/5f2b119ee036c01b7f3c3c47_Latinotype%20%20Trenda%20Regular.otf')
    format('opentype');
  font-weight: 400;
}
...
.floating-btn {
  ...
  padding: 20px 30px;
  border-radius: 6px;
  background: url('https://assets-global.website-files.com/5f2b119ee036c0684f3c3c36/634fe58345e80bcd0b4fc4c7_fin_build_no_bg.svg')
    #4417c7 no-repeat center center;
  color: white;
  font-size: 24px;
  text-align: center;
  line-height: 60px;
...
.floating--message {
  ...
  border-radius: 8px;
  animation: 0.25s cubic-bezier(0.165, 0.84, 0.44, 1) 0s 1 normal none running
    animation-bbrn0v;
}

@keyframes animation-bbrn0v {
  0% {
    opacity: 0;
...
var update = add("2a7cfd62", content, false, {});
...
/* harmony export */ });
/* harmony import */ var _widget_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1883);
...
function init(user_id) {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    setTimeout(() => {
      const audio = new Audio('https://discoverfin.s3.amazonaws.com/assets/button-124476.mp3');
      audio.play();
