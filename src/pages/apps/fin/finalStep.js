  ...
  const setupBRAND = () => {
    ...
    if (BRAND) {
      ...
      if (
        ...
        $('#learn-more').html(
          `<div class="fin_learn_more _w-100 px-8"><h1 class="heading-29 font-normal text-lg">${brand.callToAction.text}</h1></div>`,
        )
        $('#learn-more').attr('href', brand.callToAction.url)
      }
    }
  }
