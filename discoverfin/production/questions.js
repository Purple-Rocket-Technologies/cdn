...
$(".options_popup.step_3 .options_container .option").click(function () {
  let valueee = $(this).attr("data-age");
  let valueee2 = $(this).attr("data-default");
  //alert(valueee);
...
const country_val = readCookie("country");
